							...
							<nav class="navbar">
								...
								<ul class="navbar_user">
									...
									<li><a href="#"><i class="fa fa-user"
											aria-hidden="true"></i></a></li>
									<li class="checkout"><a href="/listBasket"> <i
											class="fa fa-shopping-cart" aria-hidden="true"></i> <span
											id="checkout_items" class="checkout_items">${sessionScope.elementSize}
										</span>
									</a></li>
								</ul>
...
<h3> ${ cookie.lastThreeItem.value }</h3>
					...
					<div class="col">
						<div class="product-grid"
							...
							<c:forEach var="product" items="${sessionScope.products}">
								<div class="product-item ${product.filter}">
									<div class="product discount product_filter">
										<div class="product_image">
											<a data-toggle="modal"
												onclick="latestThreeProduct('${product.id}')"
												data-target="#<c:out value="${product.id}" />"><img
												src="<c:out value="${product.img1}" />" alt=""></a>
										</div>
									...
									<div class="red_button add_to_cart_button">
										<a class="addToCart"
											href="addItemToBasket?productId=${product.id}">add to
											cart</a>
									</div>
								</div>
								...
								<!-- Modal -->
								<div class="modal fade" id="<c:out value="${product.id}" />"
